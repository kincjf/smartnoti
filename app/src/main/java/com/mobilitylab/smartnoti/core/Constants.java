...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "com.mobilitylab.smartnoti";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = "SmartNoti";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "com.mobilitylab.smartnoti.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "com.mobilitylab.smartnoti.";
