# SmartNoti
Scheduling becomes Smarter! Notification/Management App for Scheduling

## HOW TO
Learn how to develop with IntelliJ and Gradle.
* [install fabric.io for android](https://fabric.io/sign_up?signup_campaign_id=https://get.fabric.io)
...
signed with a different key.  Manually uninstall SmartNoti from your device and
...
SmartNoti is a result of a template project I've developed over the years as well as
...
SmartNoti is built on the awesome [Parse.com API](http://www.parse.com/)
...
* [fabric.io](https://get.fabric.io/) Built by the same team 
that built Crashlytics.


## Contributors
Thank you to all the [contributors](http://www.github.com.mobilitylab.smartnoti/com-mobilitylab-smartnoti/contributors) on
...
[pull requests](https://github.com.mobilitylab.smartnoti/com-mobilitylab-smartnoti/pulls).
